    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, max_length=30, null=True, verbose_name='Тип обращения(обратный звонок)')),
                ('available', models.BooleanField(blank=True, default=False, null=True, verbose_name='Статус позвоноли')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.PositiveIntegerField(blank=True, default=0, null=True, verbose_name='Скидки')),
